...
function GlobalObj () {
	...
	this.maxIteration = 1; // Int, max (inclusive) iterations. Used by build script to auto generate the other iterations. Default is 0 (i.e 1 iteration total).
	this.sipIteration = 100; // At which point in the list of iterations are they SIP iterations. Iteration 1 and all iterations after are flagged as "SIPs". 
	...
	this.webfonts = ["Avenir", "frutigerlight_cn"]; // Add each webfont name | Example - ['impactregular','keep_calm_medregular'];
